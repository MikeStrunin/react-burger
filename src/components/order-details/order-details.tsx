...
const OrderDetails = (): React.JSX.Element => { // @ts-ignore.
            ...
            {orderRequest ? (
                ...
                <>
                    <div className={styles.container}>
                        <p className="pt-30 text text_type_digits-large">{order ?? "ошибочка с выдачей номера, обратитесь в инфо-службу"}</p>
